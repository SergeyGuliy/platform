  ...
  <div>
    ...
    <v-container-title-wrapper>
      <v-container-title-name>
        {{ localStep === STEP_MAIN ? "Текст" : "Текст" }}
            ...
            <div class="builder-box__layouts">
              <label>
                ...
                <div class="builder-box__layouts-wrapper">
                  <v-tools-pages-blocks-textarea-preview :request="request" :block="content" :layout="item.value">
...
<script>
import { PAGE_BLOCK_TEXTAREA_LAYOUTS } from "../../../../../stubs/tools-pages";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      localStep: STEP_MAIN,
      layouts: PAGE_BLOCK_TEXTAREA_LAYOUTS
    };
  }
};
</script>
