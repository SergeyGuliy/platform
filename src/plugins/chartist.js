  ...
  Vue.component("Chartist", {
    ...
    methods: {
      ...
      draw: function draw() {
        this.chart = this.hasNoData
          ? null
          : new this.$chartist[this.type](this.$refs.chart, this.data, this.options, this.responsiveOptions);
    ...
    render: function render(h) {
      ...
      return h(
        ...
        {
          ref: "chart",
          class: [this.ratio, _defineProperty({}, this.noDataOptions.class, this.noData)]
        },
        children
      );
    }
