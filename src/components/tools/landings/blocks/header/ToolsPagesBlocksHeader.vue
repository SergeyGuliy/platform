  ...
  <div>
    ...
    <v-form @submit="send" id="page-create-form">
      <template v-if="localStep === STEP_MAIN">
        ...
        <v-content-showable title="Номер телефона" showable v-model="show.phone">
          <v-phone-mask name="phone" rules="required" v-model="content.phone" />
        </v-content-showable>
      </template>
            ...
            <div class="builder-box__layouts">
              <label>
                ...
                <div class="builder-box__layouts-wrapper">
                  <v-tools-pages-blocks-header-preview :request="request" :block="content" :layout="item.value">
  ...
  data() {
    ...
    return {
      ...
      show: {
        ...
        phone: content.phone ? true : false
      },
