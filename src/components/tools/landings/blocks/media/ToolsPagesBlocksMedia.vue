  ...
  <div>
    ...
    <v-form @submit="send" id="page-create-form">
      <template v-if="localStep === STEP_MAIN">
        ...
        <v-content-showable title="Текст" showable v-model="show.text">
            ...
            <div class="builder-box__layouts">
              <label>
                ...
                <div class="builder-box__layouts-wrapper">
                  <v-tools-pages-blocks-media-preview :request="request" :block="content" :layout="item.value">
