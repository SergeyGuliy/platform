  ...
  <div>
    ...
    <v-container-title-wrapper>
      <v-container-title-name>
        {{ localStep === STEP_MAIN ? "Кнопка с ссылкой" : "" }}
            ...
            <div class="builder-box__layouts">
              <label>
                ...
                <div class="builder-box__layouts-wrapper">
                  <v-tools-pages-blocks-button-preview :request="request" :block="content" :layout="item.value">
...
<script>
import { PAGE_BLOCK_BUTTON_LAYOUTS } from "../../../../../stubs/tools-pages";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      layouts: PAGE_BLOCK_BUTTON_LAYOUTS
    };
  }
};
</script>
