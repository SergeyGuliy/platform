...
import { LEARNING_LECTURE_RESOURCE_REMOVE } from "@/updated/modules/learning/store/mutation-types";
...
export default {
  ...
  methods: {
    ...
    removeResource(idx) {
      this[LEARNING_LECTURE_RESOURCE_REMOVE]({
        chapterId: this.$route.params.chapterId,
        lectureId: this.config.fillerId,
        idx
      });
    }
  }
